                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel" style="color: black;">Add City</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="{{ route('ville.ajouter')}}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <label for="Nom" style="font-size: 20px; color: black;">Nom de la ville</label>
                              <input class="form-control" type="text"  name="nom" id="npm" style="border-radius: 10px;">
                              <label for="Photo" style="font-size: 20px; color: black;">Photo</label>
                              <input class="form-control" type="file" name="photo" id="photo">
                              <label for="" style="font-size: 20px; color: black;">Chemin</label>
                              <input class="form-control" type="text" name="bouton" id="bouton">
            ...
            @foreach ($villes as $ville)
              ...
              <div class="modal fade" id="example2Modal" tabindex="-1" aria-labelledby="example2ModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h1 class="modal-title fs-5" id="exampleModalLabel" style="color: black;">Edit City</h1>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                              <form action="{{ route('ville.update', ['id' => $ville->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')

                                <input type="hidden" name="id" style="display: none;" value="{{ $ville->id }}">

                                <label for="Nom" style="font-size: 20px; color: black;">Nom de la ville</label>
                                <input class="form-control" type="text"  name="nom" id="npm" style="border-radius: 10px;" value="{{ $ville->nom }}">
                                <label for="Photo" style="font-size: 20px; color: black;">Photo</label>
                                <input class="form-control" type="file" name="photo" id="photo" value="{{ $ville->photo }}">
                                <label for="Bouton" style="font-size: 20px; color: black;">Chemin</label>
                                <input class="form-control" type="text" name="bouton" id="bouton" value="{{ $ville->bouton }}">
                ...
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            ...
                            <th class="column-title">Chemin</th>
                        ...
                        <tbody>
                          @foreach ($villes as $ville)
                            ...
                            <tr class="even pointer">
                                ...
                                <td style="font-size: 15px"> {{ $ville->id }}  </td>
                                <td style="font-size: 15px"> {{ $ville->nom }}  </td>
                                <td>
                                    <img src="{{ asset('storage/images/' . $ville->photo) }}" alt="ville" width="80" style="border-radius: 50%;">
                                </td>
                                <td style="font-size: 15px"> {{ $ville->bouton }}  </td>
                                
                                <td style="font-size: 15px">
                                    <a  href="#" data-bs-toggle="modal" data-bs-target="#example2Modal" data-id="{{ $ville->id }}"><i class='fas fa-edit m-2' style='color: green;'></i></a>
                                    <a href="/ville/delete/{{ $ville->id }}"><i class='fas fa-trash m-2' style='color: red;'></i></a>
                                </td>
                            </tr>
                            </tbody>
                          @endforeach
