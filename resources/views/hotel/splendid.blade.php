...
<body>
    ...
    <div id="carouselExempleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner" >
            <div class="carousel-item active">
                <img src="{{asset('image/sil1.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Splendide Hôtel</h5>
    ...
    <div class="container" style="text-align: center;">
        <div>
            <h1 class="mt-5">SPLENDIDE Hôtel</h1>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="container">
            <div class="box-container">
                <div class="box">
                    <img src="{{asset('splendide/splen1.jpg')}}" alt="...">
                    <div class="content">
                        <h3>vip famille</h3>
                ...
                <div class="box">
                    <img src="{{asset('splendide/splen2.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('splendide/splen3.jpg')}}" alt="...">
                    <div class="content">
                        <h3>chambre vip</h3>
                ...
                <div class="box">
                    <img src="{{asset('splendide/splen4.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('splendide/splen5.jpg')}}" alt="...">
                    <div class="content">
                        <h3>famille</h3>
                ...
                <div class="box">
                    <img src="{{asset('splendide/splen6.jpg')}}" alt="...">
                    <div class="content">
                        <h3>chambre + salon</h3>
                        <p>Trouver ici tout ce qui est succeptible d'être dans une chambre</p>
                    </div>
                ...
                <div class="box">
                    <img src="{{asset('splendide/splen7.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('image/splen2.jpg')}}" alt="...">
                    <div class="content">
                        <h3>bar</h3>
                ...
                <div class="box">
                    <img src="{{asset('image/cascade5.jpg')}}" alt="...">
                    <div class="content">
