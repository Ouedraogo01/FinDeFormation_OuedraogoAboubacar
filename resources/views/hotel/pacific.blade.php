...
<body>
    ...
    <div id="carouselExempleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner" >
            <div class="carousel-item active">
                <img src="{{asset('pacific/pac1.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Pacific Hôtel</h5>
            ...
            <div class="carousel-item">
                <img src="{{asset('pacific/pac2.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Pacific Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
            ...
            <div class="carousel-item">
                <img src="{{asset('pacific/pac3.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Pacific Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
            ...
            <div class="carousel-item">
                <img src="{{asset('pacific/pac4.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Pacific Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
            ...
            <div class="carousel-item">
                <img src="{{asset('pacific/pac5.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Pacific Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
    ...
    <div class="container" style="text-align: center;">
        <div>
            <h1 class="mt-5">Pacific Hôtel</h1>
            <i class="fas fa-star" style="color: blue"></i>
            <i class="fas fa-star" style="color: blue"></i>
            <i class="far fa-star" style="color: blue"></i>
            <i class="far fa-star" style="color: blue"></i>
            <i class="far fa-star" style="color: blue"></i>
            <p class="text-primary"><i class="far fa-compass"></i>Bobo-Dioulasso, Burkina Faso</p>
        </div>
    </div>
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="container">
            <div class="box-container">
                <div class="box">
                    <img src="{{asset('pacific/pac9.jpg')}}" alt="...">
                    <div class="content">
                        <h3>vip famille</h3>
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac1.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac2.jpg')}}" alt="...">
                    <div class="content">
                        <h3>chambre vip</h3>
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac3.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac4.jpg')}}" alt="...">
                    <div class="content">
                        <h3>famille</h3>
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac5.jpg')}}" alt="...">
                    <div class="content">
                        <h3>chambre + salon</h3>
                        <p>Trouver ici tout ce qui est succeptible d'être dans une chambre</p>
                    </div>
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac6.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac7.jpg')}}" alt="...">
                    <div class="content">
                        <h3>bar</h3>
                ...
                <div class="box">
                    <img src="{{asset('pacific/pac8.jpg')}}" alt="...">
                    <div class="content">
