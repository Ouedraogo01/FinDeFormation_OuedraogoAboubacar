...
<body>
    ...
    <div id="carouselExempleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner" >
            <div class="carousel-item active">
                <img src="{{asset('saby/saby10.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Saby Hôtel</h5>
            ...
            <div class="carousel-item">
                <img src="{{asset('saby/saby4.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Saby Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
            ...
            <div class="carousel-item">
                <img src="{{asset('saby/saby2.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Saby Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
            ...
            <div class="carousel-item">
                <img src="{{asset('saby/saby9.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Saby Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
            ...
            <div class="carousel-item">
                <img src="{{asset('saby/saby1.jpg')}}" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5 class="animated fadeInDown" style="animation-delay: 1s">Saby Hôtel</h5>
                    <p class="animated fadeInUp d-done d-md-block text-warning">Pour vos meilleurs séjours</p>
                    <p class="animated fadeInUp" style="animation-delay: 2s">
    ...
    <section class="gallery" id="gallery">
        ...
        <div class="container">
            <div class="box-container">
                <div class="box">
                    <img src="{{asset('saby/saby1.jpg')}}" alt="...">
                    <div class="content">
                        <h3>vip famille</h3>
                ...
                <div class="box">
                    <img src="{{asset('saby/saby2.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('saby/saby3.jpg')}}" alt="...">
                    <div class="content">
                        <h3>chambre vip</h3>
                ...
                <div class="box">
                    <img src="{{asset('saby/saby4.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('saby/saby5.jpg')}}" alt="...">
                    <div class="content">
                        <h3>famille</h3>
                ...
                <div class="box">
                    <img src="{{asset('saby/saby6.jpg')}}" alt="...">
                    <div class="content">
                        <h3>chambre + salon</h3>
                        <p>Trouver ici tout ce qui est succeptible d'être dans une chambre</p>
                    </div>
                ...
                <div class="box">
                    <img src="{{asset('saby/saby7.jpg')}}" alt="...">
                    <div class="content">
                ...
                <div class="box">
                    <img src="{{asset('saby/saby8.jpg')}}" alt="...">
                    <div class="content">
                        <h3>bar</h3>
                ...
                <div class="box">
                    <img src="{{asset('saby/saby10.jpg')}}" alt="...">
                    <div class="content">
